...
$apc_captcha_key = "{$_SERVER['SERVER_NAME']}~register-captcha:{$_SERVER['REMOTE_ADDR']}";
$apc_captcha_blocked_key = "{$_SERVER['SERVER_NAME']}~register-captcha-blocked:{$_SERVER['REMOTE_ADDR']}";
